        ...
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {field.type === 'select' ? (
            ...
            <div className="flex items-end pb-0.5">
              ...
              >
                <span
                  className={`inline-block h-4 w-4 rounded-full bg-white shadow-sm transform transition-transform duration-200 ${field.required ? 'translate-x-6' : 'translate-x-1'}`}
                />
              </button>
...
export default function CustomFormBuilderModal({
  isOpen,
      ...
      try {
        ...
        if (Array.isArray(imported)) {
          ...
          const valid = imported.every(
            (t) => t.id && typeof t.name === 'string' && Array.isArray(t.schema),
          );
          if (valid) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        className="absolute inset-0 bg-slate-900/25 dark:bg-slate-900/70 backdrop-blur-sm animate-fade-in"
        onClick={onClose}
      />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">
                Design your custom input forms
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="w-64 bg-slate-50/50 dark:bg-slate-900/50 border-r border-slate-100 dark:border-slate-800 flex flex-col overflow-y-auto p-4 shrink-0">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-violet-600 hover:text-violet-700 dark:text-violet-400 dark:hover:text-violet-300 p-1"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
