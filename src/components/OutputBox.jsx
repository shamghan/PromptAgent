      ...
      <div className={`relative rounded-xl overflow-hidden transition-all duration-300 ${output ? 'bg-slate-900 shadow-xl shadow-slate-900/10' : 'bg-slate-50 border border-slate-200 border-dashed'}`}>
        ...
        {output && (
          <div className="flex items-center gap-2 px-4 py-3 bg-slate-800/50 border-b border-slate-700/50">
            ...
            <span className="ml-2 text-xs font-mono text-slate-400">claude-prompt.txt</span>
          </div>
        )}
        ...
        {output && (
          <div className="flex items-center justify-between px-4 py-2 bg-slate-800/50 border-t border-slate-700/50">
            <span className="text-xs text-slate-400">Generated by <span className="text-brand-400">llama-3.3-70b</span></span>
